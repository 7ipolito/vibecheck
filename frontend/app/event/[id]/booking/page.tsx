            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <Button variant="outline" size="icon" onClick={decreaseTickets} disabled={ticketCount <= 1}>
                    <Minus className="h-4 w-4" />
                  </Button>
                  <span>{ticketCount}</span>
                  <Button variant="outline" size="icon" onClick={increaseTickets} disabled={ticketCount >= 10}>
